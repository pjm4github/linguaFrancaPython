#!/usr/bin/env python
""" generated source for module PythonValidator """
...
from org.lflang.generator import CodeMap

from org.lflang.generator import DiagnosticReporting

# from org.lflang.generator.DiagnosticReporting import Strategy

from org.lflang.generator import Position

from org.lflang.generator import ValidationStrategy

from org.lflang.generator import Validator
...
class PythonValidator(Validator):
    ...
    #          }
    #      }
    PylintNoNamePattern = re.compile("Instance of '(?<name>\\w+)' has no .*")
    fileConfig = None
    errorReporter = None
    codeMaps = None
    ...
    #                   program being built.
    #       
    def __init__(self, fileConfig, errorReporter, codeMaps, protoNames):
        """ generated source for method __init__ """
        super(PythonValidator, self).__init__(codeMaps)
        self.fileConfig = fileConfig
        self.errorReporter = errorReporter
        self.codeMaps = ImmutableMap.copyOf(codeMaps)
        self.protoNames = ImmutableSet.copyOf(protoNames)
    ...
    def getPossibleStrategies(self):
        ...
        #                      "python3",
        #                      list("-c", "import compileall; compileall.compile_dir('.', quiet=1)"),
        #                      true,
        ...
        #                  if (main.matches()) {
        #                      int line = Integer.parseInt(main.group("line"));
        #                      Iterable relevantMaps = null;
        #  //                     codeMaps.keySet().stream()
        #  //                                                              .filter(p -> main.group().contains(p.getFileName().__str__()))
        ...
        #                  return LFCommand.get(
        #                      "pylint",
        #                      list("--output-format=json", generatedFile.getFileName().__str__()),
        #                      true,
        ...
        #                  if (message.symbol == "trailing-whitespace" || message.symbol == "line-too-long") return true;
        ...
        #                  return message.symbol == "no-member"
        ...
        #                  String humanMessage
        #              ) {
        #                  if (!lfEnd == Position.ORIGIN && !lfStart == Position.ORIGIN) { // Ideal case
        ...
        #                      if (lfStart == Position.ORIGIN) lfStart = adjust.apply(
        ...
        #                      if (lfStart == Position.ORIGIN && severity != DiagnosticSeverity.Error) return;
