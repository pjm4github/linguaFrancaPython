#!/usr/bin/env python
""" generated source for module TargetTypes """
...
class TargetTypes(object):
    ...
    #          //init.stream().map(it -> getTargetExpr(it, inferredType)).collect(Collectors.toList());
    ...
    #              return escapeIdentifier(((ParameterReference) expr).getParameter().__name__);
